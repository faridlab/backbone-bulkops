//! Specifications for BulkJob aggregate
//!
...
// Each predicate implements `Specification<BulkJob>` and can be combined
...
//
// pub struct ActiveBulkJobSpec;
// impl Specification<BulkJob> for ActiveBulkJobSpec {
//     fn is_satisfied_by(&self, e: &BulkJob) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
